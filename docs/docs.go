    ...
    "paths": {
        ...
        "/login": {
            "post": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error\" example({\"message\":\"Could not authenticate user\"})",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/signup": {
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "User created successfully\" example({\"message\":\"User created and verification mail sent\"})",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/users": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal server error\" example({\"message\":\"Could not retrieve users\"})",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/verify": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Email verified successfully\" example({\"message\":\"Email verified successfully\"})",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "500": {
                        "description": "Internal server error\" example({\"message\":\"Could not fetch user\"})",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
